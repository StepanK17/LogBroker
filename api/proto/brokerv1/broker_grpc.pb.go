...
const (
	BrokerService_CreateTopic_FullMethodName        = "/broker.v1.BrokerService/CreateTopic"
	...
	BrokerService_GetCommittedOffset_FullMethodName = "/broker.v1.BrokerService/GetCommittedOffset"
)
...
type BrokerServiceClient interface {
	...
	GetCommittedOffset(ctx context.Context, in *GetCommittedOffsetRequest, opts ...grpc.CallOption) (*GetCommittedOffsetResponse, error)
}
...
func (c *brokerServiceClient) GetCommittedOffset(ctx context.Context, in *GetCommittedOffsetRequest, opts ...grpc.CallOption) (*GetCommittedOffsetResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetCommittedOffsetResponse)
	err := c.cc.Invoke(ctx, BrokerService_GetCommittedOffset_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BrokerServiceServer interface {
	...
	GetCommittedOffset(context.Context, *GetCommittedOffsetRequest) (*GetCommittedOffsetResponse, error)
...
func (UnimplementedBrokerServiceServer) GetCommittedOffset(context.Context, *GetCommittedOffsetRequest) (*GetCommittedOffsetResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetCommittedOffset not implemented")
}
...
func _BrokerService_GetCommittedOffset_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetCommittedOffsetRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BrokerServiceServer).GetCommittedOffset(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BrokerService_GetCommittedOffset_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BrokerServiceServer).GetCommittedOffset(ctx, req.(*GetCommittedOffsetRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BrokerService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetCommittedOffset",
			Handler:    _BrokerService_GetCommittedOffset_Handler,
		},
	},
